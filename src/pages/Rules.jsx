...
const Rules = () => {
  return (
    <div className="mnPg">
      ...
      <div className="mnBdy">
        <ol>
         <h3> The universe of the Game of Life is an infinite, two-dimensional
          ...
          adjacent. At each step in time, the following transitions occur:</h3>
          <li>
            {" "}
        ...
        <ol>
          {" "}
          <h3>These rules, which compare the behavior of the automaton to real life,
          can be condensed into the following:</h3>
